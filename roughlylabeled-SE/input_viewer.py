...
train_image_paths2, train_mask_paths2  = get_images_diaretAL(image_dir2, preprocess=args.preprocess, phase='train')
...
if True:
    if net_name == 'unet':
        ...
        train_dataset = DiaretALDataset(train_image_paths2, train_mask_paths2, 4, transform=
                                Compose([
